...
namespace Gyak2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Write($" = {productOfFactorial}");
            #endregion
            ...
            #region 9. feladat
            Console.WriteLine("8. Give a time value in seconds");
            ...
            Console.Clear();
            #endregion
            // hiányzik/hibás: piros konzol szín nem áll vissza
            ...
            do
            {
                ...
                if (numInBasetwo.Length%8==0&&numInBasetwo.Length!=32)
                {
                    numInBasetwo += " ";
                }
                numInBaseten /= 2;
            } while (33>numInBasetwo.Length);
            string invertedNumInBaseTwo = "";
            for (int i = numInBasetwo.Length-1; i > 0; i--)
            {
                invertedNumInBaseTwo += numInBasetwo[i];
            }
            ...
            do
            {
                ...
                if (input.Key.Equals(ConsoleKey.Spacebar))
                {
                    ...
                    int num1 = randomRoll.Next(1, 100);
                    int num2 = randomRoll.Next(1, 100);
                    int num3 = randomRoll.Next(1, 100);
